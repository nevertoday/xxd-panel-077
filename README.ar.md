...
# 🦁 XXD Panel 077｜رسم مجلة السفر

### يعيد بناء الصورة كمجلة سفر من نحت ورقي وظلال ناعمة ودفء إنساني
...
تبقى `sample-01`–`sample-04` محجوزة لنماذج الإصدار الأصلية القابلة للتحقق. تضم الأعمال الثمانية أعلاه أربعة نماذج أفقية 16:9 بتكوين يسار–يمين وأربعة نماذج رأسية 3:4 بتكوين أعلى–أسفل. ولّد Panel 077 كل عمل بصورة مستقلة وفق موجّهه الأصلي، من دون إعادة استخدام أعمال أي Panel آخر. تستخدم النماذج نصاً إنجليزياً مولّداً بذكاء.
...
يختزل **Panel 077** العنصر والفعل والمحيط وعلاقة المشهد إلى كولاج نحتي ورقي. تصنع محيطات الورق المقصوص الواضحة والطبقات الأمامية والخلفية والنسيج الخفيف والحواف المقطوعة والظلال الناعمة عمقًا ملموسًا. يحذف الخلفية الزائدة ويعيد ضبط ألوان الماكرون من أكثر إشارات الأصل حيوية ودفئًا، لينتهي كمجلة سفر راقية أو دورية فنية مستقلة.

### مناسب لـ

- تحويل صور السفر إلى منشور فني ورقي يعيد تنظيم العنصر وعلاقات المشهد، لا إلى نسخة مصغرة من الصورة؛
- طبقات حقيقية ضمن أسلوب مسطح، تبني فيها حواف الورق المقطوعة والتراكب الأمامي والخلفي والظلال الناعمة ملمساً بلا بلاستيك ثلاثي الأبعاد ثقيل؛
- ألوان ماكرون لطيفة ومشرقة تنبع من حيوية الأصل وحرارته الشعورية، لا من لوحة حلوى ثابتة؛
- مخرجات أعلى–أسفل ويسار–يمين وتصميم فقط ونسب متعددة وحزم خلفيات ومعالجة المجلدات.

### بداية سريعة

> استخدم XXD Panel 077 لمعالجة هذه الصورة واقترح أولاً أنسب تكوين وحجم.
...
**البصمة:** نحت ورقي بسيط · محيطات قص واضحة · طبقات أمامية وخلفية · ظل ناعم · ماكرون إنساني · طباعة مجلة سفر
...
|---|---|
| **الناتج** | ملصق كولاج راقٍ بعمق ورقي ملموس وسرد واضح وطابع منشور سفر |
| **البصمة الواضحة** | أشكال ملخصة وحواف ورق مقصوص وطبقات وظلال ناعمة ونص مجلّي منخفض الوزن |
| **احترام المصدر** | يحفظ العنصر والفعل والمحيط وعلاقة المشهد، ويحذف فقط ما لا يدعم الشعور والسرد |
...
```text
استخلاص العنصر والفعل والمحيط وعلاقة المشهد → اختزالها إلى أشكال ورق مقصوص → تنظيم طبقات أمامية وخلفية وقص موضعي → عمق يدوي بنسيج الورق والحواف والظل الناعم → إعادة ضبط ألوان الأصل العاطفية إلى ماكرون → فراغ هادئ → طباعة مجلة سفر منخفضة الوزن
```

## سمات النتيجة النهائية

- تحافظ الأشكال الملخصة ومحيطات القص الواضحة على الهوية من دون واقعية أو اختزال كرتوني.
- تصنع طبقات الورق والحواف والنسيج الخفيف والظلال الناعمة عمقًا ملموسًا مقتصدًا.
- تُحذف الخلفية والتفاصيل الثانوية التي لا تدعم الشعور أو علاقة المشهد.
- تبقى ألوان الماكرون خفيفة ودافئة ومنعشة بلا اتساخ أو قدم أو فلورسنت أو حلاوة رخيصة.
- يندمج عنوان واحد وقليل من حروف الآلة الكاتبة بوزن منخفض مع الورق والفراغ.

توجد القيود الجمالية فقط في [الموجّه الأصلي](references/original-prompt/zh-CN.md). يعالج الـ Skill ومهايئات التشغيل متغيرات التسليم فقط. [Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-077-prompt.en.md)
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 077. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-077 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-077 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-077 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-077 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-077 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 077 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-077 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-077`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-077-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-077-prompt.zh-CN.md)

<!-- xxd-panel-catalog:start -->
## دليل مشاريع XXD Panel الكامل

يحافظ كل مشروع من مشاريع Panel الـ77 على موجّهه الأصلي ومنطقه الجمالي المستقل. يسرد الجدول المشاريع من 001 إلى 077 دون أرقام مفقودة، مع تمييز المشروع الحالي بخط عريض.
...
| **الجنود** | `xxd-panel-NNN` (حالياً 001–077) | تنفذ كل مهارة مرقمة موجّهها الأصلي وجماليتها الخاصة فقط، وتنجز المهمة الفردية التي يرسلها الجنرال. |
